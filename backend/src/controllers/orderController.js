...
const placeOrder = async (req, res) => {
  try {
    ...
    const parsedWalletAmount =
      Number(walletAmount) || 0;

    console.log(
      "PARSED BUY NOW PRODUCT ID:",
      parsedBuyNowProductId
    );

    console.log(
      "PARSED BUY NOW QUANTITY:",
      parsedBuyNowQuantity
    );

    console.log(
      "PARSED WALLET AMOUNT:",
      parsedWalletAmount
    );
