...
const createOrderFromCart = async (
  ...
  try {
    ...
    if (
      ...
      throw new Error(
        `Invalid payment method: ${finalPaymentMethod}`
      );
    }
    ...
    if (
      ...
      if (
        ...
        */
        ...
        if (
          ...
          throw new Error(
            "Wallet balance is ₹0.00. Please select UPI or another payment method."
          );
        }
      ...
      if (
        ...
        if (
          ...
          throw new Error(
            "Wallet amount must be greater than ₹0.00"
          );
        }
        ...
        if (
          ...
          throw new Error(
            `Insufficient wallet balance. Available: ₹${currentBalance.toFixed(
              2
            )}, Requested: ₹${requestedWalletAmount.toFixed(
              2
            )}`
          );
        }
        ...
        if (
          ...
          throw new Error(
            "For full wallet payment, use WALLET payment method."
          );
        }
