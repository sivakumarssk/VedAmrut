...
export default function ScannerScreen() {
  ...
  const handleBarcodeScanned = async ({
    ...
    try {
      ...
      // CLAIM STATUS
      // IMPORTANT:
      // CLAIM STATUS IS SEPARATE FROM GIFT AVAILABILITY
      // =================================================
      ...
      //
      // Even if reward = 0:
      // GiftCardScreen will show "Gift Not Available"
      //
      // If reward > 0:
      // GiftCardScreen will show the scratch card.
      // =================================================
      ...
      router.push({
        ...
        params: {
          ...
          // Actual claim status from backend
          isClaimed:
            String(isClaimed),
        },
      });
        ...
        >
          {permission.granted ? (
            <CameraView
              ...
              // IMPORTANT:
              // Keep barcode listener attached.
              // handleBarcodeScanned itself prevents
              // duplicate scans.
              onBarcodeScanned={
